        ...
        <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              I'm a self-taught Full-Stack web developer who loves solving
              problems, learning new technologies, and languages. I enjoy coding
              things from scratch that improves the lives of those around me!
            </p>
